# set working directory to bcurce file
...
bcg <- datagridClassGBM2("C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Breast Cancer Small",
                         "C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Breast Cancer",
...
dat1A <- bcg$dat20A
dat1LCL <- bcg$dat20LCL
dat1Time <- bcg$dat20Time
...
tmp1 <- ggplot(bc1.1, aes(x = IntDepth, y = NumTrees)) +
...
tmp2 <- ggplot(bc1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% UCLs for Breast Cancer Data, Shrinkage = 10^(-3)") +
...
tmp3 <- ggplot(bc1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% Errors for Breast Cancer Data, Shrinkage = 10^(-2)") +
...
tmp4 <- ggplot(bc1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% UCLs for Breast Cancer Data, Shrinkage = 10^(-2)") +
...
pdf("../Grid Search Plots/GBM/Binary/GBM_Binary_Complete_Breast_Cancer.pdf", height = 9, width = 6.5)
