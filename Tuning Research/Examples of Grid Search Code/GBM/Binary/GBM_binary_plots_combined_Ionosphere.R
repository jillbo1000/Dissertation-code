# set working directory to iource file
...
iog <- datagridClassGBM2("C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Ionosphere Small",
                         "C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Ionosphere",
                         dataset = "Ionosphere")
...
# Ionosphere Errors for shrinkage = 10^(-1)
io1.1 <- alldat1[alldat1$cat == "Ionosphere", ]

g1.1 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All Errors for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4) 

g2.1 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = ErrUCL)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Error UCLs for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

g3.1 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Time)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

# Ionosphere Errors for shrinkage = 10^(-2)
io1.2 <- alldat2[alldat2$cat == "Ionosphere", ]

g1.2 <- ggplot(io1.2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All Errors for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4) 

g2.2 <- ggplot(io1.2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = ErrUCL)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Error UCLs for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)

g3.2 <- ggplot(io1.2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Time)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)

# Ionosphere Errors for shrinkage = 10^(-2)
io1.3 <- alldat3[alldat3$cat == "Ionosphere", ]

g1.3 <- ggplot(io1.3, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All Errors for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4) 

g2.3 <- ggplot(io1.3, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = ErrUCL)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Error UCLs for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)

g3.3 <- ggplot(io1.3, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Time)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
dat20A <- iog$dat20A
dat20LCL <- iog$dat20LCL
dat20Time <- iog$dat20Time
dat1A <- iog$dat20A
dat1LCL <- iog$dat20LCL
dat1Time <- iog$dat20Time
best20A <- iog$top20acc
best20LCL <- iog$top20LCL
best20Time <- iog$top20Time
...
g4.1 <- ggplot(dat20A.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Errors for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.1 <- ggplot(dat20LCL.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.1 <- ggplot(dat20Time.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ionosphere Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.2 <- ggplot(dat20A.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Errors for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.2 <- ggplot(dat20LCL.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.2 <- ggplot(dat20Time.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ionosphere Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.3 <- ggplot(dat20A.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Errors for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.3 <- ggplot(dat20LCL.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.3 <- ggplot(dat20Time.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ionosphere Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)

tmp1 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
...
tmp2 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% UCLs for Ionosphere Data, Shrinkage = 10^(-3)") +
...
tmp3 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% Errors for Ionosphere Data, Shrinkage = 10^(-2)") +
...
tmp4 <- ggplot(io1.1, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = Error), fill ="white") +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("Best 20% UCLs for Ionosphere Data, Shrinkage = 10^(-2)") +
...
pdf("../Grid Search Plots/GBM/Binary/GBM_Binary_Complete_Ionosphere.pdf", height = 9, width = 6.5)
