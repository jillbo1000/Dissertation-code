...
sog <- datagridClassGBM2("C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Sonar Small",
                         "C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Sonar",
                         dataset = "Sonar")
...
dat1A <- sog$dat20A
dat1LCL <- sog$dat20LCL
dat1Time <- sog$dat20Time
...
pdf("../Grid Search Plots/GBM/Binary/GBM_Binary_Complete_Sonar.pdf", height = 9, width = 6.5)
