...
iog <- datagridClassGBM("C:/Users/jflun/Dropbox/Dissertation/Tuning Research/Grid Search/Grid Data/GBM/Binary/Ionosphere Small",
                        dataset = "Ionosphere")
...
pdf("../Grid Search Plots/GBM/Binary/GBM_Binary_Small_Ionosphere.pdf", height = 9, width = 6.5)
