...
g2.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  ggtitle("All MSE UCLs for CO2 Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for CO2 Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

# CO2 MSEs for shrinkage = 10^(-2)

g1.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = MSE)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g1.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
dat20A <- cog$dat20A
dat20UCL <- cog$dat20UCL
dat20Time <- cog$dat20Time
dat1A <- cog$dat20A
dat1UCL <- cog$dat20UCL
dat1Time <- cog$dat20Time
best20A <- cog$top20acc
best20UCL <- cog$top20UCL
best20Time <- cog$top20Time
...
g4.1 <- ggplot(dat20A.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for CO2 Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

# ggplot(dat20A.1, aes(x = IntDepth, y = NumTrees)) +
#   geom_tile(aes(fill = MSE)) +
#   geom_point(data = lig1$dat1A, aes(IntDepth, NumTrees),
#              size = 2, color = "orange1") +
#   theme_bw() +
#   labs(x = "interaction.depth", y = "n.trees") +
#   ggtitle("Best 20% MSEs for CO2 Data, Shrinkage = 10^(-1)") +
...
g5.1 <- ggplot(dat20UCL.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for CO2 Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.1 <- ggplot(dat20Time.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for CO2 Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.2 <- ggplot(dat20A.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.2 <- ggplot(dat20UCL.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.2 <- ggplot(dat20Time.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for CO2 Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.3 <- ggplot(dat20A.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.3 <- ggplot(dat20UCL.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.3 <- ggplot(dat20Time.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for CO2 Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
pdf("../../Grid Search Plots/GBM/Regression/GBM_CO2.pdf", height = 9, width = 6.5)
