...
alldat <- ohg$datAll
summary(alldat)
nrow(alldat[alldat$MSE > 1e+13, ]) # $[1] 720

alldat <- alldat[alldat$MSE < 1e+13, ]
summary(alldat)
...
g2.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  ggtitle("All MSE UCLs for Ohio Housing Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ohio Housing Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

# Ohio Housing MSEs for shrinkage = 10^(-2)

g1.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = MSE)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)

# Ohio Housing MSEs for shrinkage = 10^(-3)

g1.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = MSE)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
dat20A <- ohg$dat20A
dat20UCL <- ohg$dat20UCL
dat20Time <- ohg$dat20Time
dat1A <- ohg$dat20A
dat1UCL <- ohg$dat20UCL
dat1Time <- ohg$dat20Time
best20A <- ohg$top20acc
best20UCL <- ohg$top20UCL
best20Time <- ohg$top20Time
...
g4.1 <- ggplot(dat20A.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Ohio Housing Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.1 <- ggplot(dat20UCL.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ohio Housing Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.1 <- ggplot(dat20Time.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ohio Housing Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.2 <- ggplot(dat20A.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.2 <- ggplot(dat20UCL.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.2 <- ggplot(dat20Time.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ohio Housing Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.3 <- ggplot(dat20A.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.3 <- ggplot(dat20UCL.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.3 <- ggplot(dat20Time.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Ohio Housing Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
pdf("../../Grid Search Plots/GBM/Regression/GBM_Ohio_Housing.pdf", height = 9, width = 6.5)
