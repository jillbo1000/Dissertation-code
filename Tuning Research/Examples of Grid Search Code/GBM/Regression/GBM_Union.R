...
alldat <- ung$datAll
summary(alldat)
nrow(alldat[alldat$MSE > 100000, ]) # $[1] 600
...
g2.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  ggtitle("All MSE UCLs for Union Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.1 <- ggplot(alldat1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Union Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)

# Union MSEs for shrinkage = 10^(-2)

g1.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  geom_tile(aes(fill = MSE)) +
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.2 <- ggplot(alldat2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g1.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "Number of Trees") +
  ggtitle("All MSEs for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4) 
...
g2.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All MSE UCLs for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g3.3 <- ggplot(alldat3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("All Times for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
dat20A <- ung$dat20A
dat20UCL <- ung$dat20UCL
dat20Time <- ung$dat20Time
dat1A <- ung$dat20A
dat1UCL <- ung$dat20UCL
dat1Time <- ung$dat20Time
best20A <- ung$top20acc
best20UCL <- ung$top20UCL
best20Time <- ung$top20Time
...
g4.1 <- ggplot(dat20A.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Union Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.1 <- ggplot(dat20UCL.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Union Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.1 <- ggplot(dat20Time.1, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Union Data, Shrinkage = 10^(-1)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.2 <- ggplot(dat20A.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.2 <- ggplot(dat20UCL.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.2 <- ggplot(dat20Time.2, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Union Data, Shrinkage = 10^(-2)") +
  facet_wrap(~MinNode, ncol = 4)
...
g4.3 <- ggplot(dat20A.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% MSEs for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g5.3 <- ggplot(dat20UCL.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% UCLs for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
g6.3 <- ggplot(dat20Time.3, aes(x = IntDepth, y = NumTrees)) +
  ...
  theme_bw() +
  labs(x = "interaction.depth", y = "n.trees") +
  ggtitle("Best 20% Times for Union Data, Shrinkage = 10^(-3)") +
  facet_wrap(~MinNode, ncol = 4)
...
pdf("../../Grid Search Plots/GBM/Regression/GBM_Union.pdf", height = 9, width = 6.5)
